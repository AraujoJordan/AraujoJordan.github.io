...
export function Projects() {
    const projects = [
        {
            title: "ServiceTitan Field",
            category: "Role: Senior Android Engineer",
            icon: <img src="/servicetitan_field.jpg" alt="ServiceTitan Field" className="w-full h-full object-cover" />,
            description: "Building the next-gen field service mobile app for technicians across trades.",
            content: [
            ...
            tags: ["Kotlin", "Compose", "Offline-First", "Real-Time Sync", "GPS", "AI"]
        },
        {
            title: "Instacart",
